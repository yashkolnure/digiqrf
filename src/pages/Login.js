    ...
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-5 md:px-10"
      ...
      <div className="max-w-6xl mx-auto flex items-center h-16 gap-6">
        ...
        <div className="hidden md:flex items-center gap-2 flex-shrink-0">
          <Link to="/signup" className="flex items-center gap-1.5 px-4 py-2 text-sm font-bold font-display rounded-lg text-white transition-all hover:opacity-90"
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t px-5 py-4 flex flex-col gap-3" style={{ borderColor: C.border }}>
          ...
          <div className="flex flex-col gap-2 pt-3 border-t" style={{ borderColor: C.border }}>
            <Link to="/signup" className="w-full text-center py-2.5 text-sm font-bold font-display rounded-lg text-white"
              style={{ background: C.primary }}>Get Started Free</Link>
          </div>
        </div>
      )}
    </nav>
        ...
        <main className="flex-grow flex items-center justify-center p-5 pt-28 pb-16">
          ...
          <div className="w-full max-w-md p-8 md:p-10 rounded-2xl shadow-xl transition-all"
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-xs font-bold font-display uppercase tracking-wider" style={{ color: C.mid }}>
                    Password
                  </label>
                  <Link to="/forgot-password" className="text-xs font-bold font-display transition-colors hover:underline" style={{ color: C.primary }}>
                    Forgot?
                  </Link>
                </div>
                <input
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-2 flex items-center justify-center gap-2 py-3.5 rounded-xl text-sm font-bold font-display text-white transition-all hover:opacity-90 hover:-translate-y-px disabled:opacity-70 disabled:hover:translate-y-0"
            ...
            <p className="text-center mt-8 text-sm font-body" style={{ color: C.muted }}>
              ...
              <Link to="/signup" className="font-bold font-display transition-colors hover:underline" style={{ color: C.dark }}>
                Create one now
              </Link>
            </p>
          </div>
